  ...
  async function onSubmit(formData) { 
    await fetch('/api/send', {
      ...
      body: JSON.stringify({
        ...
        page : 'Round Tour In Sri Lanka (Colombo, Nuwara Eliya, Bentota)',
      ...
      <section className={`sm:flex gap-8 px-5 sm:px-17.5 mt-7.5 sm:mt-0 ${toBottom ? "items-end" : ""}`}>
        <article className="sm:basis-3/5">
          <div onMouseEnter={() => setToBottom(false)}>
            <h2 className="text-testimonials leading-8 sm:leading-none sm:text-5xl font-normal font-Calistoga text-hero-2 ">Round Tour In Sri Lanka (Colombo, Nuwara Eliya, Bentota)</h2>
            ...
            <div className="mt-6 sm:pt-7 pt-9 pb-6 pl-5 pr-3.5 border-[0.5px] border-trip-border rounded-lang mb-5 sm:hidden">
              ...
              <h4 className="space-x-1.5">
                <span className="text-2xl sm:text-testimonials font-Helvetica font-bold text-black leading-10">USD 162</span>
            ...
            <div className="mt-12.5 mb-12.5 sm:mb-17.5">
              ...
              <p className="text-base sm:text-hero-text-1 text-hero-3 font-Helvetica font-light leading-6 mb-7.5">
                Embark on a captivating 4-day journey through the scenic landscapes and cultural marvels of Sri Lanka. From the majestic Pinnawala Elephant Orphanage to the sacred Temple of the Tooth Relic in Kandy, immerse yourself in the rich heritage of this island nation. Explore the lush tea plantations and cascading waterfalls of Nuwara Eliya before unwinding on the sun-kissed beaches of Bentota. Delight in cultural shows, spice gardens, and wildlife encounters, all while enjoying warm hospitality and breathtaking vistas at every turn. Experience the best of Sri {`Lanka's`} natural beauty and vibrant culture on this unforgettable adventure.
              </p>
            ...
            <div className="pt-11 pb-8 px-5 border-[0.5px] border-trip-border rounded-lang mb-12.5 sm:hidden">
              ...
              <p className="text-sm sm:text-base font-Helvetica text-hero-3 font-light leading-5 sm:leading-6 mb-5 sm:mb-6">Celebrate your wanderlust with us! Fill out the form below to start planning your next adventure.</p>
              ...
              {faqs.map((item, index, faqsArray) => {
                if(item.day === "01") return (
                  ...
                  >
                    <p className="text-services text-hero-3 font-Helvetica font-light leading-5 mb-7.5">
                      Arrive at Bandaranaike International Airport, met by our representative, proceed to Kandy, En route visit <span className="font-semibold">Pinnawala Elephant Orphanage</span>, 
                      <span className="font-semibold">Zoo</span> and <span className="font-semibold">Spice garden</span>.
                    </p>

                    <h4 className="text-services font-Helvetica leading-5 text-hero-3 font-semibold underline-offset-2 decoration-solid underline mb-5">
                      Elephant Orphanage
                    </h4>
                    ...
                    <p className="text-services text-hero-3 font-Helvetica font-light leading-5 mt-2">
                      Next, proceed to the Kandy and check into the Hotel.
                    </p>
                    ...
                    <ul className="text-services text-hero-3 font-Helvetica font-light leading-5 space-y-2 mb-7.5 list-disc list-inside">
                      <li>Including Gem Museum And Craft Center,</li>
                      <li>Upper Lake Drive (Boat ride across the lake)</li>
                      <li>The Market</li>
                    </ul>

                    <p className="text-services text-hero-3 font-Helvetica font-light leading-5 mb-5">
                    ...
                    <p className="text-services text-hero-3 font-Helvetica font-semibold leading-5 mt-5 mb-10">
                      Gala Dinner With DJ Music And Overnight Stay At Hotel In Kandy.
                    </p>
                  </AccordionItem>
                )
                ...
                if(item.day === "03") return (
                  ...
                  >
                    ...
                    <p className="text-services text-hero-3 font-Helvetica font-light leading-5">
                      Proceed to Bentota and at leisure;
                    </p>
                ...
                // if(item.day !== "04" || item.day !== "01") return (
                //   <AccordionItem
                //     key={item.title}
                //     num={index}
                //     title={item.title}
                ...
                //         {item.activities.map((activity, index) => <span className="block">{activity}</span>)}
                //       </p>
                //     )}
                ...
                if(item.day === "04") return (
                  ...
                  >
                    ...
                    <p className="text-services text-hero-3 font-Helvetica font-light leading-5 mt-5 mb-12.5">
                      After Breakfast, leave for the Airport for Departure.
                    </p>
                  </AccordionItem>
                )
              })}
        ...
        <div className="sm:basis-2/5 hidden sm:flex flex-col h-full">
          <div className="pt-7 pb-6 pl-5 pr-3.5 border-[0.5px] border-trip-border rounded-lang mb-5">
            ...
            <h4 className="space-x-1.5">
              <span className="text-testimonials font-Helvetica font-bold text-black leading-10">USD 162</span>
...
const faqs = [
  ...
  },
  {
    ...
    day: "03",
    locations: [
      "4 Location", "Back To Beachside"
    ],
    title: "Journey Bentota",
    arrival: "Colombo",
    transfers: [
...
export default TravelPackageRound
